...
backdrop-blur-xl px-4"
        ...
        >
          ...
          >
            <div
              className="relative rounded-3xl bg-[#0b0b0b] border border-white/10
            ...
            >
              ...
              <button
                className="absolute top-5 right-5 z-20 transition text-lg
              ...
              <div className="relative px-8 pt-14 pb-10 text-center">
                <h1
                  className="inline-block mb-6 px-4 py-1.5 rounded-full bg-white/5
